...
export default async function (app) {
    app.post("/create", {
        schema: {
            description: "Create a new conversation with the given users. This method will also fetch a persistent conversation if the persistenceToken is provided and the conversation exists.",
            summary: "create",
            tags: ["conversation"],
        ...
        if (persistenceToken) {
            conversation = await conversationManager.getConversationByPersistenceToken(persistenceToken);
